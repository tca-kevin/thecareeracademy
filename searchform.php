<form role="search" method="get" action="<?php echo home_url(); ?>" class="grow">
	<div class="relative">
		...
		<button type="submit" aria-label="<?php echo __('Search', 'thecareeracademy'); ?>" value="" class="bg-white border-none p-0 absolute top-1/2 right-3 -translate-y-1/2 cursor-pointer group">
