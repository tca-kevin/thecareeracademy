													...
													foreach ($menu_item['children'] as $menu_item_child_index => $menu_item_child) { ?>
														<div x-data x-disclosure>
															<div class="flex items-center gap-x-0 sm:gap-x-2" x-data="{ show_menu_item_grand_child_<?php echo $menu_item_child_index; ?>: false }">
																...
																<a href="<?php echo $menu_item_child['url']; ?>" aria-label="<?php echo $menu_item_child['title']; ?>" x-on:click="show_menu_item_grand_child_<?php echo $menu_item_child_index; ?> = !show_menu_item_grand_child_<?php echo $menu_item_child_index; ?>" x-bind:class="{ 'text-green-500 bg-green-500 bg-opacity-10 transition-all' : show_menu_item_grand_child_<?php echo $menu_item_child_index; ?> }" class="font-sans font-normal text-base text-black px-4 py-px my-2 no-underline w-full transition-all hover/x:bg-green-500 hover/x:bg-opacity-10 hover/x:text-green-500">
