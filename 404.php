...
<div class="container mx-auto px-4 mt-48 flex flex-col justify-center items-center gap-y-4">
	...
	<a href="<?php echo home_url(); ?>" aria-label="<?php echo __('Back to Home', 'thecareeracademy'); ?>" class="inline-flex justify-center items-center gap-x-2 font-sans font-semibold text-base text-white no-underline min-w-36 bg-orange-500 px-4 py-2 border-solid border-2 border-orange-500 rounded-md transition-all hover:bg-orange-400 hover:border-orange-400">
