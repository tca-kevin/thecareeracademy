<?php $menu_items = array_values(get_menu_items('footer')); ?>
<footer>
	<div class="bg-green-500 py-10 md:py-20">
		<div class="container mx-auto px-4 grid grid-cols-12 gap-y-8 lg:gap-y-0">
			<div class="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col items-center md:items-start lg:items-start gap-y-8">
				<a href="<?php echo home_url(); ?>" aria-label="<?php echo __('Company Logo', 'thecareeracademy'); ?>" class="lg:pt-12">
					<svg class="h-20 fill-white transition-all hover:fill-orange-400" version="1.1" id="The_Career_Academy" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
	...
	c-1.2,0.2-2.5,0.6-3.9,1.2c0.8-0.6,1.9-1.3,3.1-1.9c2.6-1.3,5.4-2,8.4-2c0.5,0,0.8-0.4,0.8-0.8V4.9H38L38,27.3L38,27.3z" />
		...
		c-2.4,0.5-4.1,1.3-5.8,2.6c-0.4,0.3-0.4,0.8-0.1,1.2C24.1,21.5,24.4,21.6,24.6,21.6L24.6,21.6z" />
				...
				<div class="hidden md:flex gap-x-2 gap-y-2">
					<a href="<?php echo get_field('company_facebook_link', 'option')['url']; ?>" aria-label="<?php echo get_field('company_facebook_link', 'option')['title']; ?>" target="<?php echo get_field('company_facebook_link', 'option')['target']; ?>" class="inline-flex bg-green-400 px-2 py-2 rounded-md transition-all hover:bg-[#1877F2]">
						<svg class="size-5 fill-white" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
							<path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
						</svg>
					</a>
					<a href="<?php echo get_field('company_instagram_link', 'option')['url']; ?>" aria-label="<?php echo get_field('company_instagram_link', 'option')['title']; ?>" target="<?php echo get_field('company_instagram_link', 'option')['target']; ?>" class="inline-flex bg-green-400 px-2 py-2 rounded-md transition-all hover:bg-[#DD2A7B]">
						<svg class="size-5 fill-white" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
					...
					<a href="<?php echo get_field('company_youtube_link', 'option')['url']; ?>" aria-label="<?php echo get_field('company_youtube_link', 'option')['title']; ?>" target="<?php echo get_field('company_youtube_link', 'option')['target']; ?>" class="inline-flex bg-green-400 px-2 py-2 rounded-md transition-all hover:bg-[#FF0000]">
						<svg class="size-5 fill-white" viewBox="0 0 576 512" xmlns="http://www.w3.org/2000/svg">
							<path d="M549.655 124.083c-6.281-23.65-24.787-42.276-48.284-48.597C458.781 64 288 64 288 64S117.22 64 74.629 75.486c-23.497 6.322-42.003 24.947-48.284 48.597-11.412 42.867-11.412 132.305-11.412 132.305s0 89.438 11.412 132.305c6.281 23.65 24.787 41.5 48.284 47.821C117.22 448 288 448 288 448s170.78 0 213.371-11.486c23.497-6.321 42.003-24.171 48.284-47.821 11.412-42.867 11.412-132.305 11.412-132.305s0-89.438-11.412-132.305zm-317.51 213.508V175.185l142.739 81.205-142.739 81.201z"></path>
						</svg>
					</a>
					<a href="<?php echo get_field('company_twitter_link', 'option')['url']; ?>" aria-label="<?php echo get_field('company_twitter_link', 'option')['title']; ?>" target="<?php echo get_field('company_twitter_link', 'option')['target']; ?>" class="inline-flex bg-green-400 px-2 py-2 rounded-md transition-all hover:bg-[#1DA1F2]">
						<svg class="size-5 fill-white" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
					...
					<a href="<?php echo get_field('company_linkedin_link', 'option')['url']; ?>" aria-label="<?php echo get_field('company_linkedin_link', 'option')['title']; ?>" target="<?php echo get_field('company_linkedin_link', 'option')['target']; ?>" class="inline-flex bg-green-400 px-2 py-2 rounded-md transition-all hover:bg-[#0072b1]">
						<svg class="size-5 fill-white" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col gap-y-4">
				<a href="<?php echo $menu_items[0]['url']; ?>" aria-label="<?php echo $menu_items[0]['title']; ?>" target="<?php echo $menu_items[0]['target']; ?>" class="font-sans font-semibold text-xl text-lime-500 transition-all hover:text-orange-400"><?php echo $menu_items[0]['title']; ?></a>
				<?php if (isset($menu_items[0]['children'])) { ?>
					<ul class="list-none p-0 m-0 flex flex-col gap-y-1">
						<?php foreach ($menu_items[0]['children'] as $menu_item_child_index => $menu_item_child) { ?>
							<li>
								<a href="<?php echo $menu_item_child['url']; ?>" aria-label="<?php echo $menu_item_child['title']; ?>" target="<?php echo $menu_item_child['target']; ?>" class="font-sans font-normal text-lg text-white transition-all hover:text-orange-400"><?php echo $menu_item_child['title']; ?></a>
							</li>
						<?php }	?>
					</ul>
				<?php }	?>
			...
			<div class="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col gap-y-4">
				<?php if (isset($menu_items[1]['children'])) { ?>
					<a href="<?php echo $menu_items[1]['url']; ?>" aria-label="<?php echo $menu_items[1]['title']; ?>" target="<?php echo $menu_items[1]['target']; ?>" class="font-sans font-semibold text-xl text-lime-500 transition-all hover:text-orange-400"><?php echo $menu_items[1]['title']; ?></a>
					<ul class="list-none p-0 m-0 flex flex-col gap-y-1">
						<?php foreach ($menu_items[1]['children'] as $menu_item_child_index => $menu_item_child) { ?>
							<li>
								<a href="<?php echo $menu_item_child['url']; ?>" aria-label="<?php echo $menu_item_child['title']; ?>" target="<?php echo $menu_item_child['target']; ?>" class="font-sans font-normal text-lg text-white transition-all hover:text-orange-400"><?php echo $menu_item_child['title']; ?></a>
							</li>
						<?php }	?>
			...
			<div class="col-span-12 md:col-span-6 lg:col-span-3 flex flex-col gap-y-4">
				<a href="<?php echo $menu_items[2]['url']; ?>" aria-label="<?php echo $menu_items[2]['title']; ?>" target="<?php echo $menu_items[2]['target']; ?>" class="font-sans font-semibold text-xl text-lime-500 transition-all hover:text-orange-400"><?php echo $menu_items[2]['title']; ?></a>
				<ul class="list-none p-0 m-0 flex flex-col gap-y-1">
					<?php if (get_field('company_email_address', 'option')) { ?>
						<li class="flex flex-col 2xl:flex-row">
							<span class="inline-block min-w-24 font-sans font-semibold text-lg text-white"><?php echo __('Email:', 'thecareeracademy') ?></span>
							<a href="<?php echo get_field('company_email_address', 'option')['url']; ?>" aria-label="<?php echo get_field('company_email_address', 'option')['url']; ?>" target="<?php echo get_field('company_email_address', 'option')['target']; ?>" class="font-sans font-normal text-lg text-white transition-all hover:text-orange-400"><?php echo get_field('company_email_address', 'option')['title']; ?></a>
						</li>
					<?php } ?>
					<?php if (get_field('company_phone_number', 'option')) { ?>
						<li class="flex flex-col 2xl:flex-row">
							<span class="inline-block min-w-24 font-sans font-semibold text-lg text-white"><?php echo __('Phone:', 'thecareeracademy') ?></span>
							<a href="<?php echo get_field('company_phone_number', 'option')['url']; ?>" aria-label="<?php echo get_field('company_phone_number', 'option')['url']; ?>" target="<?php echo get_field('company_phone_number', 'option')['target']; ?>" class="font-sans font-normal text-lg text-white transition-all hover:text-orange-400"><?php echo get_field('company_phone_number', 'option')['title']; ?></a>
						</li>
					<?php } ?>
					<?php if (get_field('company_phone_number_2', 'option')) { ?>
						<li class="flex flex-col 2xl:flex-row">
							<span class="inline-block min-w-24 font-sans font-semibold text-lg text-white"><?php echo __('Toll Free:', 'thecareeracademy') ?></span>
							<a href="<?php echo get_field('company_phone_number_2', 'option')['url']; ?>" aria-label="<?php echo get_field('company_phone_number_2', 'option')['url']; ?>" target="<?php echo get_field('company_phone_number_2', 'option')['target']; ?>" class="font-sans font-normal text-lg text-white transition-all hover:text-orange-400"><?php echo get_field('company_phone_number_2', 'option')['title']; ?></a>
						</li>
					<?php } ?>
				...
				<div class="flex md:hidden justify-center gap-x-2 gap-y-2 pt-4">
					<a href="<?php echo get_field('company_facebook_link', 'option')['url']; ?>" aria-label="<?php echo get_field('company_facebook_link', 'option')['title']; ?>" target="<?php echo get_field('company_facebook_link', 'option')['target']; ?>" class="inline-flex bg-green-400 px-2 py-2 rounded-md transition-all hover:bg-[#1877F2]">
						<svg class="size-5 fill-white" viewBox="0 0 320 512" xmlns="http://www.w3.org/2000/svg">
							<path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
						</svg>
				...
				<h2 class="font-druk-wide font-normal text-xl sm:text-3xl md:text-xl lg:text-3xl text-white text-center lg:text-left my-0"><?php echo get_field('footer_button_header', 'options'); ?></h2>
				<a href="<?php echo get_field('footer_button_link', 'option')['url']; ?>" aria-label="<?php echo get_field('footer_button_link', 'option')['title']; ?>" target="<?php echo get_field('footer_button_link', 'option')['target']; ?>" class="inline-flex justify-center items-center gap-x-1 font-sans font-semibold text-base text-white text-nowrap min-w-36 bg-orange-500 px-4 py-2 border-solid border-2 border-orange-500 rounded-md transition-all hover:bg-orange-400 hover:border-orange-400 hover:shadow-md">
					<?php echo get_field('footer_button_link', 'option')['title']; ?>
				</a>
			</div>
		</div>
	</div>
	<div class="bg-green-400 py-0.5">
		<div class="container mx-auto px-4 font-sans font-normal text-sm text-white leading-5 text-center">
